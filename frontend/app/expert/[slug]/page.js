  ...
  const fetchExpert = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/experts?filters[slug][$eq]=${slug}&populate[expert_experiences][populate]=target_company&populate[expert_experiences][populate]=sub_industry&populate[expert_experiences][populate]=latest_update_details&populate[expert_experiences][sort][0]=createdAt:desc&populate[projects][populate]&populate[last_update]=*`,
